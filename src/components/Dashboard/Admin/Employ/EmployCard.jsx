    ...
    { accessorKey: "email", header: "Email" },
    {
      ...
      cell: ({ row }) => (
        <div className="flex space-x-4">
          <motion.button
            onClick={() => handleUpdateViewId(row.original.id, 2)}
            className="bg-green-500 cursor-pointer text-white px-3 py-1 rounded-lg hover:bg-green-600 transition"
          >
            <FaRegEye />
          </motion.button>
          <motion.button
            onClick={() => handleUpdateViewId(row.original.id, 1)}
          ...
          <motion.button
            ...
            className="bg-yellow-500 text-white cursor-pointer px-3 py-1 rounded-lg hover:bg-yellow-600 transition"
          >
            <FaEdit />
          </motion.button>
          <motion.button
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-end space-x-2 mt-4">
                <motion.button
                  ...
                  className="bg-gray-500 text-white cursor-pointer px-3 py-1 rounded-lg hover:bg-gray-600 transition"
                >
                  Cancel
                </motion.button>
                <motion.button
                  type="submit"
                  className="bg-blue-600 text-white px-3 py-1 rounded-lg cursor-pointer hover:bg-blue-700 transition"
                >
